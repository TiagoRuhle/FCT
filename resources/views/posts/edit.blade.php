...
@section('content')    
    <form method="POST" action="{{url('/post')}}">
      ...
      <input type="text" class="form-control  @if($errors->any('titulo')) @if($errors->has('titulo')) is-invalid @else is-valid @endif @endif" id="titulo" name="titulo" value="{{$post->titulo}}">
        @error('titulo')
      ...
      <div class="form-group">
        <label for="area"><p class="font-weight-bold">Area</p> <br><small>Use o CTRL para selecionar várias</small></label> 
